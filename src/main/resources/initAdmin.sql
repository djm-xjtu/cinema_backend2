...
-- ----------------------------
INSERT INTO `admin_menu` VALUES ('1', '/admin', 'AdminIndex', 'homePage', 'el-icon-s-home', 'AdminIndex', '0');
INSERT INTO `admin_menu` VALUES ('2', '/admin/dashboard', 'DashboardAdmin', 'Operation', null, 'dashboard/admin/index', '1');
...
INSERT INTO `admin_menu` VALUES ('5', '/admin', 'System', 'System Configuration', 'el-icon-s-tools', 'AdminIndex', '0');
INSERT INTO `admin_menu` VALUES ('6', '/admin/user/profile', 'Profile', 'User Info', null, 'user/UserProfile', '3');
INSERT INTO `admin_menu` VALUES ('7', '/admin/user/role', 'Role', 'Role Configuration', null, 'user/Role', '3');
INSERT INTO `admin_menu` VALUES ('8', '/admin/content/movie', 'MovieManagement', 'Camera Manage', null, 'content/MovieManagement', '4');
INSERT INTO `admin_menu` VALUES ('9', '/admin/content/banner', 'BannerManagement', 'Advertising Management', null, 'content/BannerManagement', '4');
INSERT INTO `admin_menu` VALUES ('10', '/admin/content/article', 'ArticleManagement', 'Article Management', null, 'content/ArticleManagement', '4');
...
-- ----------------------------
INSERT INTO `admin_role` VALUES ('1', 'sysAdmin', 'System Manager', '1');
INSERT INTO `admin_role` VALUES ('2', 'contentManager', 'Content Manager', '1');
