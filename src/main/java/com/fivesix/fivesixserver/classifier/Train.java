...
public class Train {
    ...
    // 文档列表
    public static final String POS_DOCS_PATH = System.getProperty("user.dir")+"/src/main/java/com/fivesix/fivesixserver/classifier/pos.txt";
    public static ArrayList<String> posDocs = new ArrayList<>();
    public static final String NEG_DOCS_PATH = System.getProperty("user.dir")+"/src/main/java/com/fivesix/fivesixserver/classifier/neg.txt";
