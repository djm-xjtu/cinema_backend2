...
public class MyClassifier {
    ...
    public static final String MODEL_PATH =System.getProperty("user.dir")+"/src/main/java/com/fivesix/fivesixserver/classifier/weibo-model";
